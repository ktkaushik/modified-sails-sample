...
module.exports = (function() {
  ...
  var adapter = {
    ...
    describe: function(collectionName, cb) {
      ...
      console.log( dbs[collectionName].schema );
      ...
      spawnConnection(function __DEFINE__(connection, cb) {
        connection.createCollection(collectionName, function __DEFINE__(err, result) {
          ...
          connection.collection(collectionName, function(err, collection) {
            ...
            console.log('***************** inside processKey ***************************');
            console.log('***************** key ***************************');
            console.log(key);
            console.log(def[key]);

            console.log('******* is unique ********************')
            console.log(def[key].unique)
            console.log('******* is autoIncrement ********************')
            console.log(def[key].autoIncrement)
    ...
    find: function(collectionName, options, cb) {
      ...
      spawnConnection(function(connection, cb) {
        connection.collection(collectionName, function(err, collection) {
          ...
          console.log('^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^');
          console.log('^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^');
          console.log( dbs[collectionName] );
          collection.find.apply( collection, criteria.parseFindOptions(options) ).toArray( function(err, docs) {
            console.log( '%%%%%%%%%%%%%%%%%%%%%% inside the find apply %%%%%%%%%%%%%%%%%%%%%%%%%%%%%' );
            console.log( docs );
  ...
  function spawnConnection(logic, config, cb) {
    console.log('********* in spawnConnection **************************************');
